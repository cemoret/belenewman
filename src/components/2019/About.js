...
class About extends Component {
  constructor(props) {
    ...
    this.state = {
      RRSS: {
        instagram: [
          { name: "Instagram", http: `${"https://www.instagram.com/cemoret/"}` }
        ],
        twitter: [
          { name: "Twitter", http: `${"https://www.twitter.com/carlosmoret/"}` }
        ],
        pinterest: [
          { name: "Pinterest", http: `${"https://www.pinterest.com/cemoret/"}` }
        ],
        arena: [{ name: "Are.na", http: `${"https://www.are.na/ce-moret/"}` }],
        github: [
          { name: "Github", http: `${"https://www.github.com/cemoret/"}` }
        ]
      },
      Tech: {
        ...
        t7: [
          { name: "Apollo Client", http: `${"https://www.apollographql.com/"}` }
        ],
        ...
        t13: [
          { name: "Swift", http: `${"https://developer.apple.com/swift/"}` }
        ]
      },
      Software: {
        ...
        t4: [
          {
            ...
            http: `${"https://www.invisionapp.com/studio"}`
          }
        ],
        t5: [
          {
              ...
              <div className="col-md-3 col-12">
                <div className="">
                  ...
                  <h4 className="light">
                    ...
                    <br />
                    <br />
                    Based in Barcelona and working worldwide, I focuses on all
                    phases of a product, from discovery to delivery and
                    iteration, and helps brands to guide decisions based on
                    user-centered design.
                    <br />
                    <br />I create experiences that are useful, useable, and
                    beautiful, distinguishable by a unique blending of art,
                    design, and idealism, working to use visual communication as
                    a tool to transcend style and time.
                  </h4>
                </div>
              </div>
              <div className="col-md-3 col-12">
                <div className="">
                  ...
                  <h4>
                    ...
                    >
                      <span className="underline text-nobrand">
                    ...
                    <a
                      rel="noopener noreferrer"
                      target="_blank"
                      href={RRSS.pinterest[0].http}
                    >
                      <span className="underline text-nobrand">
                        {RRSS.pinterest[0].name}
                      </span>
                    </a>
                    <br />
                    <a
